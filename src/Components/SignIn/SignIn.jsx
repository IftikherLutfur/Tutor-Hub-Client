...
>
  ...
  <div className="w-full max-w-sm relative z-10 p-6 m-auto text-black rounded-lg shadow-md bg-[#1D1D1D] pt-6" >
    <form className="mt-6">
      <div>
      ...
      <div className="mt-6">
        <button 
          className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform  rounded-lg hover:border-2 bg-zinc-700 "
        >
          Sign In
        </button>
      </div>
